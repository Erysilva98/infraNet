...
const app = require('./server/app'); // ajuste o caminho conforme sua estrutura
const sequelize = require('./server/api/data/db');

// Modelos utilizados nos testes
const Acesso = require('./server/api/models/acessoModel');
const Avisos = require('./server/api/models/avisosModel');
const Servicos = require('./server/api/models/servicosModel');
const Contato = require('./server/api/models/contatoModel');
