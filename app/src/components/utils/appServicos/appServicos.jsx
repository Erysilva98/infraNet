...
const assets = `/assets/`;
const url = 'http://localhost:3000/pages/404';  // Default URL for fallback

// Individual card for each service
const AppServicosCard = ({ img_path, titulo, descricao }) => {
  return (
...
export default function AppServicos({ dados }) {
